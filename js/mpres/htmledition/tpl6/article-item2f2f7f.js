...
return e=e.format("X")>w.format("X")?w.format(x):e.format(x),g.loopDay(i,e,function(i){
s.push(i);
var e=t.summary[i];
a.push({
name:i,
...
var c=t("common/wx/pager.js"),h=t("statistics/chart/pie.js"),l=template.compile(t("tpl/statistics/article-item.html.js")),_=template.compile(t("tpl/statistics/article-item-nested-media.html.js")),m=t("statistics/components/event-emitter.js"),u=t("biz_web/ui/dropdown.js"),p=jQuery,f=t("biz_common/moment.js"),g=t("statistics/common.js"),v=g.map,j=0,w=f().add("d",-1),y=250,b=467,C={
...
this.sources=[];
var t=[["int_page_from_session_read_count","公众号会话"],["int_page_from_friends_read_count","好友转发"],["int_page_from_feed_read_count","朋友圈"],["int_page_from_hist_msg_read_count","历史消息"],["int_page_from_other_read_count","其它"]],i=this,e=this.article;
t.each(function(t){
